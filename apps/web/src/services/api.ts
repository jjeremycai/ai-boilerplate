...
export class ApiClient {
  ...
  async cancelSubscription() {
    return this.request<{ success: boolean }>('/billing/subscription/cancel', {
      method: 'POST',
    })
  }

  async resumeSubscription() {
    return this.request<{ success: boolean }>('/billing/subscription/resume', {
      method: 'POST',
    })
  }
  ...
  async getOrganizationMembers(id: string) {
    return this.request<any[]>(`/organizations/${id}/members`)
  }

  async addOrganizationMember(id: string, data: { userId: string; role?: 'admin' | 'member' }) {
    return this.request<{ success: boolean }>(`/organizations/${id}/members`, {
      method: 'POST',
      body: JSON.stringify(data),
    })
  }

  async updateOrganizationMember(orgId: string, userId: string, data: { role: 'admin' | 'member' }) {
  ...
  async transferOrganizationOwnership(id: string, data: { newOwnerId: string }) {
    return this.request<{ success: boolean }>(`/organizations/${id}/transfer`, {
      method: 'POST',
      body: JSON.stringify(data),
    })
  }
  ...
  async deleteOrganization(id: string) {
    return this.request<{ success: boolean }>(`/organizations/${id}`, {
      method: 'DELETE',
    })
  }
}
